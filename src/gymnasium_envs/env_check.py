...
env3 = gymnasium.make("non_convex_optimization_env/ConvexOptimization-v0")
env4 = gymnasium.make("nn_optimization_env/NeuralNetworkOptimization-v0", dataset_name="MNIST")
